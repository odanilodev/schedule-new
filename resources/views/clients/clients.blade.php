...
<div class="content-body">
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="col-xl-12 col-xxl-12 col-md-12 col-12">
                <div class="card">
                    <div class="card-header d-block d-sm-flex border-0">
                        <div class="me-3">
                            <h4 class="card-title mb-2">Clientes</h4>
                            <span class="fs-12">listagem de todos clientes</span>
                        </div>
                    </div>
                            ...
                            <div class="table-responsive">
                                <table class="table table-responsive-md card-table transactions-table">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>
                                                <img class="bgl-success tr-icon" src="{{ URL::to('assets/images/'.Session::get('avatar')) }}" width="55" height="55" alt="">
                                            </td>

                                            <td>
                                                <h6 class="fs-16 font-w600 mb-0"><a href="javascript:void(0);" class="text-black">Victor Hugo Prado</a></h6>
                                            </td>
                                            ...
                                            <td><span class="text-success fs-16 font-w600 text-start d-block">Ativo</span></td>

                                            <td>
                                                <a href="javascript:void()" class="btn btn-info">
                                                    <i class="bi bi-pencil-square fs-16 text-white font-w600 icon-edit text-white"></i>
                                                </a>
                                            </td>

                                            <td>
                                                <a href="javascript:void()" class="btn btn-danger">
                                                    <i class="bi bi-trash-fill fs-16 text-white font-w600 icon-delete"></i>
                                                </a>
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <h6 class="fs-16 font-w600 mb-0"><a href="javascript:void(0);" class="text-black">Luis Felipe Lopes</a></h6>
                                            </td>
                                            ...
                                            <td><span class="text-danger fs-16 font-w600 text-start d-block">Inativo</span></td>
