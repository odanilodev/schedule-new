        ...
        <div class="row">
            ...
            <div class="col-xl-3 col-xxl-7">
                <div class="card">
                    ...
                    <div class="card-body">	
                        <div class="user-bx">
                            <img src="{{ URL::to('assets/images/profile/small/pic1.jpg') }}" alt="">
                            <div>
                                <h6 class="user-name">{{ Session::get('name') }}</h6>
                                <span class="meta">@soengsouy</span>
                            </div>
                        ...
                        <ul class="user-list">
                            ...
                            <li><img src="{{ URL::to('assets/images/avatar/3.jpg') }}" alt=""></li>
                            <li><img src="{{ URL::to('assets/images/avatar/4.jpg') }}" alt=""></li>
